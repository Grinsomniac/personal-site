...
const Main = () => {
    ...
    return (
        <div id='home'>
            ...
            <div className='w-full h-screen absolute top-0 left-0 bg-white/40'> {/*This is the background overlay gradient*/}
            <div className='max-w-[700px] m-auto h-full w-full flex flex-col justify-center lg:items-start items-center'>
                    ...
                    <div className='flex justify-between pt-6 max-w-[200px] space-x-4'> {/*Social icons - change space-x-4 to w-full if adding more icons*/}
                        <a href="https://github.com/Grinsomniac" target="_blank" rel="noopener noreferrer">
                            <FaGithub className='cursor-pointer' size={20}/>
                        </a>
                        <a href="https://www.linkedin.com/in/jasonjohn2000/" target="_blank" rel="noopener noreferrer">
